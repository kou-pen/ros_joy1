...
: ${AMENT_CURRENT_PREFIX:="/home/kohki/joy-recv-check/install/ctrler"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ctrler/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ctrler/environment/path.sh"
